...
namespace KatlaSport.WebApi.Controllers
{
    ...
    public class HiveSectionsController : ApiController
    {
        ...
        public async Task<IHttpActionResult> AddHiveSection([FromBody] UpdateHiveSectionRequest createRequest)
        {
            ...
            var hiveSection = await _hiveSectionService.CreateHiveSectionAsync(createRequest).ConfigureAwait(false);
        ...
        {
            await _hiveSectionService.DeleteHiveSectionAsync(id).ConfigureAwait(false);
            return ResponseMessage(Request.CreateResponse(HttpStatusCode.NoContent));
        }
    }
}
